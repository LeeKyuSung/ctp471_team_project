...
public class HttpConnectionTest {
	...
	public static void main(String[] args) throws Exception {
		...
		HttpConnectionTest http = new HttpConnectionTest();

		http.sendGet("https://www.facebook.com/ks5050577/about");
	...
	private void sendGet(String targetUrl) throws Exception {
		...
		int fromIndex = 0;
		while (true) {
			int index = responseStr.indexOf("script type=\"application/ld+json\"", fromIndex);
